...
.set("ivysaur", {rarity: 3, minTime: 2.7, minPrice: 16000, maxPrice: 20000, price: randomRange(16000, 20000)})
.set("venusaur", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
.set("charmander", {rarity: 4, minTime: 2.9, minPrice: 13000, maxPrice: 16000, price: randomRange(13000, 16000)})
.set("charmeleon", {rarity: 3, minTime: 2.7, minPrice: 16000, maxPrice: 20000, price: randomRange(16000, 20000)})
.set("charizard", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
.set("squirtle", {rarity: 4, minTime: 2.9, minPrice: 13000, maxPrice: 16000, price: randomRange(13000, 16000)})
.set("wartortle", {rarity: 3, minTime: 2.7, minPrice: 16000, maxPrice: 20000, price: randomRange(16000, 20000)})
.set("blastoise", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
...
.set("raichu", {rarity: 5, minTime: 3.1, minPrice: 13000, maxPrice: 15000, price: randomRange(13000, 15000)})
...
.set("nidoqueen", {rarity: 5, minTime: 3.1, minPrice: 9500, maxPrice: 13600, price: randomRange(9500, 13000)})
...
.set("nidoking", {rarity: 5, minTime: 3.1, minPrice: 9500, maxPrice: 13600, price: randomRange(9500, 13600)})
...
.set("ninetales", {rarity: 3, minTime: 2.7, minPrice: 25000, maxPrice: 28500, price: randomRange(25000, 28500)})
...
.set("arcanine", {rarity: 2, minTime: 2.6, minPrice: 30000, maxPrice: 40000, price: randomRange(30000, 40000)})
...
.set("poliwrath", {rarity: 4, minTime: 3.1, minPrice: 9900, maxPrice: 13300, price: randomRange(9900, 13300)})
...
.set("gengar", {rarity: 2, minTime: 2.6, minPrice: 20000, maxPrice: 25000, price: randomRange(20000, 25000)})
...
.set("exeggutor", {rarity: 3, minTime: 2.7, minPrice: 12000, maxPrice: 15400, price: randomRange(12000, 15400)})
...
.set("weezing", {rarity: 7, minTime: 3.1, minPrice: 9000, maxPrice: 11500, price: randomRange(9000, 11500)})
...
.set("chansey", {rarity: 2, minTime: 2.6, minPrice: 20000, maxPrice: 23000, price: randomRange(20000, 23000)})
...
.set("starmie", {rarity: 3, minTime: 2.7, minPrice: 10000, maxPrice: 13000, price: randomRange(10000, 13000)})
.set("mr-mime", {rarity: 8, minTime: 3.3, minPrice: 7500, maxPrice: 9000, price: randomRange(7500, 9000)})
.set("scyther", {rarity: 5, minTime: 2.9, minPrice: 10000, maxPrice: 12700, price: randomRange(10000, 12700)})
.set("jynx", {rarity: 5, minTime: 2.9, minPrice: 10000, maxPrice: 12700, price: randomRange(10000, 12700)})
.set("electabuzz", {rarity: 5, minTime: 2.9, minPrice: 10000, maxPrice: 12700, price: randomRange(10000, 12700)})
...
.set("gyarados", {rarity: 2, minTime: 2.6, minPrice: 30000, maxPrice: 36500, price: randomRange(30000, 36500)})
.set("lapras", {rarity: 2, minTime: 2.6, minPrice: 30000, maxPrice: 36500, price: randomRange(30000, 36500)})
.set("ditto", {rarity: 10, minTime: 3.5, minPrice: 5000, maxPrice: 6800, price: randomRange(5000, 6800)})
.set("eevee", {rarity: 3, minTime: 2.7, minPrice: 8500, maxPrice: 12000, price: randomRange(8500, 12000)})
.set("vaporeon", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
.set("jolteon", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
.set("flareon", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
...
.set("aerodactyl", {rarity: 2, minTime: 2.6, minPrice: 28800, maxPrice: 37600, price: randomRange(28800, 37600)})
.set("snorlax", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
.set("articuno", {rarity: 1, minTime: 2.3, minPrice: 90000, maxPrice: 125000, price: randomRange(90000, 125000)})
.set("zapdos", {rarity: 1, minTime: 2.3, minPrice: 90000, maxPrice: 125000, price: randomRange(90000, 125000)})
.set("moltres", {rarity: 1, minTime: 2.3, minPrice: 90000, maxPrice: 125000, price: randomRange(90000, 125000)})
.set("dratini", {rarity: 7, minTime: 3.3, minPrice: 5800, maxPrice: 8900, price: randomRange(5800, 8900)})
.set("dragonair", {rarity: 5, minTime: 2.9, minPrice: 9800, maxPrice: 14400, price: randomRange(9800, 14400)})
.set("dragonite", {rarity: 1, minTime: 2.4, minPrice: 45000, maxPrice: 60000, price: randomRange(45000, 60000)})
.set("mewtwo", {rarity: 1, minTime: 2.3, minPrice: 90000, maxPrice: 125000, price: randomRange(90000, 125000)})
.set("mew", {rarity: 1, minTime: 2.3, minPrice: 90000, maxPrice: 125000, price: randomRange(90000, 125000)});
